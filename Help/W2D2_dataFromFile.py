...
print("{0:10} \t {1:5} \t {2:7}".format("NAME", "AGE", "SALARY"))
print("--------------------------------")
...
with open("/Users/kmtruchon/Desktop/SE126_202040/example.csv") as csvfile:
    ...
    for rec in file:
        ...
        #print("Printing from List: {0} \t\t Printing from Var: {1}".format(rec[0], name))   
...
print("TOTAL SALARIES: ${0:10,.2f}\n\n".format(total_salaries))